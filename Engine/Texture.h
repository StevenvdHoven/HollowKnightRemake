...
public:
	...
	void Draw(const Point2f& dstBottomLeft, const Color4f color, const Rectf& srcRect = {}) const; // Esteban function
	void Draw(const Rectf& dstRect, const Color4f color, const Rectf& srcRect = {}) const; 
